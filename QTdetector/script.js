...
function setup() {
  ...
  video.elt.addEventListener('loadeddata', function() {
    ...
    if (video.elt.readyState >= 2) {
      ...
      toggleDetecting()
      toggleVideo()
      console.log(document.getElementById("defaultCanvas0").style)
      document.getElementById("defaultCanvas0").style.height = "900px"
...
function drawLabel(object) {
  ...
  // set font size
  textSize(24);
  var isPerson = object.label.toString()


  // draw string to canvas
  if (isPerson === "person") {
    text("cutie", object.x + 10, object.y + 24);
  } else {
